...
public class MapHelper {
	...
	public static BufferedImage mapImageWithOptions(double lat, double longitude, int zoom) throws IOException {
		String mapURLString = "https://maps.googleapis.com/maps/api/staticmap?center=" + Double.toString(lat) + "," + Double.toString(longitude) + "&zoom=" + Integer.toString(zoom) + "&size=" + mapSize + "x" + mapSize + "&scale=2&format=jpg";
